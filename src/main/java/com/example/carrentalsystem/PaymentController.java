...
public class PaymentController {
    ...
    private boolean insertPaymentDetails(String username, String email) {
        ...
        String query = "INSERT INTO payments (username, email, payment_method, card_number, expiry_date, cvv, bkash_phone, bkash_pin, nagad_phone, nagad_pin) " +
                "VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
        ...
        try (Connection connection = DriverManager.getConnection(url, user, password);
            ...
            statement.setString(8, bkashPin);
            statement.setString(9, nagadPhone);
            statement.setString(10, nagadPin);
